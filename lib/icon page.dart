...
class _iconPageState extends State<iconPage> {
  List<String> iconName = ["assets/images/helm.png", "assets/images/clock.png", "assets/images/hourglass.png", "assets/images/watch.png", "assets/images/boat.png"];
              ...
              onTap: () async {
                try {
                  if (await FlutterDynamicIcon.supportsAlternateIcons) {
                    await FlutterDynamicIcon.setAlternateIconName(iconfile[index]);
                  ...
                  snack();
                  widget.analytics.logEvent(name: "app_icon_change_failed",
